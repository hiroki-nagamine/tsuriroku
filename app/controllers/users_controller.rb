class UsersController < ApplicationController
  before_action :require_user_logged_in, only: [:index, :show, :destroy, :followers, :followings]
  before_action :set_users, only: [:show,:edit,:update,:followings,:followers,:likes]
  def index
